...
<form action="/addpostself?sourcePage=profile" method="post" accept-charset="UTF-8">
...
<!-- ใช้ JavaScript เพื่อแสดงข้อความ error ถ้าหลังจาก Submit แล้วไม่ได้เลือกหัวข้อ -->
<script>
